...
import com.example.nikhar.photoeditor.MainActivity;
import com.example.nikhar.photoeditor.R;
...
public class GalleryAdapter extends BaseAdapter {
	...
	public void changeSelection(View v, int position) {
		...
		ArrayList<CustomGallery> selected = getSelected();
		...
		} else
		{
			...
			{
				Toast.makeText(mContext.getApplicationContext(), "Your Are selected " + MainActivity.checkTemplateNum + " Item", Toast.LENGTH_LONG).show();
			}
			else
			{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try
		{
			...
			if (isActionMultiplePick)
			{
				...
				System.out.println("data.get(position).isSeleted=========="+data.get(position).isSeleted);
